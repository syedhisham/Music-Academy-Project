...
const HeroSection = () => {
  return (
    <div className="h-auto md:h-[40rem] w-full rounded-md flex flex-col justify-center items-center relative overflow-hidden mx-auto py-10 md:py-0">
      <Spotlight
        className="-top-36 -left-40 md:left-[25rem] md:-top-20"
        fill="white"
      />
      <div className="p-4 relative z-10 w-full text-center mt-0 md:mt-80">
      <h1 className="mt-32 md:mt-0 text-5xl md:text-8xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400">Master the art of music</h1>
